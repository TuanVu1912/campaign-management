...
const DashboardSearch = () => {
  ...
  return (
    <div className="relative z-50">
      <div className=" bg-white rounded-full flex items-center shadow-[10px_10px_20px_rgba(218,213,213,0.3)] p-2 w-full  ">
        ...
        <button className="w-[72px] justify-center flex-shrink-0 rounded-full text-white h-10 flex items-center bg-primary">
          <svg
      ...
      {showSearch && (
        <div className="search-results w-full lg:w-[843px] bg-white absolute top-full left-0 z-50 translate-y-5 pb-6 rounded-3xl">
          <div className="flex items-center  justify-between p-3 bg-graySoft rounded-3xl">
            ...
            <button
              className="flex items-center justify-center w-[72px] h-[50px] text-error
         rounded-xl bg-error bg-opacity-20"
            >
              <IconClose></IconClose>
            </button>
          </div>
          <div className="p-6 pb-0">
            ...
            <h3 className="text-sm mb-4 font-semibold">Related searchs</h3>
